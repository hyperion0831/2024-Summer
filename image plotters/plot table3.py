...
# 指定保存路径
save_path1 = 'C:/Users/25610/Desktop/online3/savenewroll1cat'
save_path2 = 'C:/Users/25610/Desktop/online3/savenewroll1catBilinear'
save_path3 = 'C:/Users/25610/Desktop/online3/savenewroll1catBicubic'  # 第三个数据集的保存路径

# 初始化
std_devs1 = {}
std_devs2 = {}
std_devs3 = {}  # 第三个数据集的标准差
...
# 创建数据表格
fields = sorted(set(std_devs1.keys()).union(std_devs2.keys()).union(std_devs3.keys()))
data = {
    'Field': fields,
    'Circular': [std_devs1[field][0] if field in std_devs1 else None for field in fields],
    'Bilinear': [std_devs2[field][0] if field in std_devs2 else None for field in fields],
    'Bicubic': [std_devs3[field][0] if field in std_devs3 else None for field in fields]  # 第三列的数据
}
...
# 绘制表格图片
fig, ax = plt.subplots(figsize=(10, 6))  # 调整图像尺寸以适应更多数据
...
# 保存表格为图片
plt.savefig(os.path.join(save_path1, 'std_dev_comparison_table_three_sets.png'), bbox_inches='tight')
plt.show()
